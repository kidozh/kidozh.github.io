...
**![](/wp-content/uploads/2015/04/042315_0932_Python1.png)    如图所示为一个牛头刨床（III级机构），假设各个构件尺寸如图表所示，原动件1以等角速度ω=1 rad/s沿逆时针方向回转，试求各从动件的角位移，角速度以及角加速度以及刨头C点的位移、速度以及角加速度的变化情况。
**
...
l4*coso4 + s3*coso3 = h2 + l1*coso1


l4*sino4 + s3*sino3 = h1 + l1*sino1


l4*coso4 + l3*coso3 – s5 = 0
...
-l4*sino4*w4 + s3'*coso3 – s3*sino3*w3 = -l1*sino1*w1


l4*coso4*w4 + s3'*sino3 + s3*coso3*w3 = l1*coso1*w1


-l4*sino4*w4 – l3*sino3*w3 – s5' = 0


l4*coso4*w4 + l3*coso3*w3 = 0


给出矩阵式：


![](/wp-content/uploads/2015/04/042315_0932_Python3.png)
...
![](/wp-content/uploads/2015/04/042315_0932_Python4.png)
...
![](/wp-content/uploads/2015/04/042315_0932_Python5.png)


速度的解：


![](/wp-content/uploads/2015/04/042315_0932_Python6.png)


角速度的解


![](/wp-content/uploads/2015/04/042315_0932_Python7.png)


A3的角加速度（好像有个峰值= =、、、）


![](/wp-content/uploads/2015/04/042315_0932_Python8.png)


A4的角加速度（小多啦= =、、）


![](/wp-content/uploads/2015/04/042315_0932_Python9.png)


由于这个是周期性的 表示本弱画了一张极坐标图片！


![](/wp-content/uploads/2015/04/042315_0932_Python10.png)


A3和A5的加速度分析


![](/wp-content/uploads/2015/04/042315_0932_Python11.png)
